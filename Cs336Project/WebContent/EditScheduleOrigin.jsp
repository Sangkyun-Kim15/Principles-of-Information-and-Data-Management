...
<html>
	<head>
		...
		<title>Updating Schedule Origin</title>
	</head>
	<body>
			<%
			try {
				...
				String station = request.getParameter("ostation");
				...
				String q2 = "update Transit.trainSchedule set originates_in = '" + stationID + "' where ScheduleID = '" + scheduleID + "'";
