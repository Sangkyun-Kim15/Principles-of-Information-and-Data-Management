...
<html>
	<head>
		...
		<title>Updating Schedule Destination</title>
	</head>
	<body>
			<%
			try {
				...
				String station = request.getParameter("dstation");
				...
				String q2 = "update Transit.trainSchedule set destination = '" + stationID + "' where ScheduleID = '" + scheduleID + "'";
